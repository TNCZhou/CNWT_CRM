...
// arguments.callee.caller (trac-13335). But as of jQuery 3.0 (2016), strict mode should be lib
...
// Includes all lib event props including KeyEvent and MouseEvent specific props
jQuery.each( {
	altKey: true,
	bubbles: true,
	cancelable: true,
