...
<body>
<form method="post" class="validform" action="<?=\yii\helpers\Url::to(['customer/person-add'])?>">
    <input type="hidden" name="customer_id" value="<?=$customerId?>" />
    <div class="mui-input-group input-group margin-vertical-sm">
        <div class="mui-input-row">
            <label>姓名</label>
            <input type="text" name="name" autocomplete="off" placeholder="请填写姓名" value="" datatype="*" nullmsg="请填写姓名" />
        </div>
        <div class="mui-input-row">
            <label>性别</label>
            <div class="input-cont">
                <?php foreach($gender as $k=>$v):?>
                    <div class="mui-radio mui-left">
                        <label><?=$v?></label>
                        <input value="<?=$k?>" name="gender" type="radio" datatype="*" nullmsg="请选择性别" />
                    </div>
                <?php endforeach;?>
            </div>
        </div>
        <div class="mui-input-row">
            <label>科室</label>
            <input type="text" name="department" autocomplete="off" placeholder="请填写科室" value="" />
        </div>
        <div class="mui-input-row">
            <label>职务</label>
            <input type="text" name="position" autocomplete="off" placeholder="请填写职务" value="" />
        </div>
<!--        <div class="mui-input-row">-->
<!--            <label>生日</label>-->
...
<!--        </div>-->
        <div class="mui-input-row">
            <label>电话</label>
            <input type="tel" name="tel" autocomplete="off" placeholder="请填写电话" value="" />
        </div>
        <div class="mui-input-row">
            <label>QQ</label>
            <input type="tel" name="qq" autocomplete="off" placeholder="请填写QQ" value="" />
        </div>
        <div class="mui-input-row">
            <label>微信</label>
            <input type="text" name="wechat" autocomplete="off" placeholder="请填写微信" value="" />
        </div>
<!--        <div class="mui-input-row">-->
<!--            <label>个人信息</label>-->
