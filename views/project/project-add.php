                        ...
                        <form action="<?=\yii\helpers\Url::to(['project/add'])?>" class="am-form am-form-horizontal validform" method="post">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-g-collapse">
                                    <div class="am-u-sm-5">
                                        <input name="plan_start_date" type="text" class="am-form-field am-radius" id="start-date" placeholder="预估开始时间" readonly="readonly" autocomplete="off" datatype="*" nullmsg="请选择预估开始时间">
                                    </div>
                                    <div class="am-u-sm-2 am-text-center am-text-sm am-padding-top-xs">至</div>
                                    <div class="am-u-sm-5">
                                        <input name="plan_end_date" type="text" class="am-form-field am-radius" id="end-date" placeholder="预估结束时间" readonly="readonly" autocomplete="off" datatype="*" nullmsg="请选择预估结束时间">
                                    </div>
